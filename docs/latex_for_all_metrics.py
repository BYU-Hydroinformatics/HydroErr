...
latex_symbols = {
    ...
    'SMAPE2': r'$sMAPE2=\frac{100\%}{n}\sum_{i=1}^{n}\left| \frac{S_i-O_i}{\frac{(S_i+O_i)}{2}} \right|$',
...
for metric in latex_symbols:
    ...
    fig.savefig('pictures/{}.png'.format(metric), dpi=250, transparent=True, format='png',
